...
func TestEncryptPKCS1v15DecrypterSessionKey(t *testing.T) {
	for i, test := range decryptPKCS1v15SessionKeyTests {
		plaintext, err := rsaPrivateKey.Decrypt(rand.Reader, decodeBase64(test.in), &internalRsa.PKCS1v15DecryptOptions{SessionKeyLen: 4})
		if err != nil {
...
func parsePublicKey(s string) *internalRsa.PublicKey {
