...
TEXT dp256SubInternal<>(SB),NOSPLIT,$0
	...
	RET
/* ---------------------------------------*/
TEXT dp256SqrInternal<>(SB),NOSPLIT,$0
	// x[1:] * x[0]
	MUL	x0, x1, acc1
	UMULH	x0, x1, acc2
	...
	RET
/* ---------------------------------------*/
TEXT dp256MulInternal<>(SB),NOSPLIT,$0
	// y[0] * x
	MUL	y0, x0, acc0
	UMULH	y0, x0, acc1
...
TEXT ·p256PointAddAsm(SB),0,$392-32
	...
	// Begin point add
	LDx(z2in)
	CALL	dp256SqrInternal<>(SB)    // z2^2
	STy(z2sqr)

	CALL	dp256MulInternal<>(SB)    // z2^3
